...
class DataProfiler:
    ...
    def _convert_to_json_serializable(obj):
        ...
        if isinstance(obj, dict):
            return {k: DataProfiler._convert_to_json_serializable(v) for k, v in obj.items()}
        elif isinstance(obj, list):
            return [DataProfiler._convert_to_json_serializable(item) for item in obj]
    ...
    def profile(self, df: pd.DataFrame, table_name: str = "data") -> Dict[str, Any]:
        ...
        return self._convert_to_json_serializable(profile)
